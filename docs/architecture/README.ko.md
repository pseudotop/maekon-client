...
| [009](./ADR-009-client-architecture-baseline.md) | Client Architecture Baseline | Accepted | `maekon-app` 패키지, web, integration runtime |
| [010](./ADR-010-local-integration-harness-boundary.md) | Local Integration Harness Boundary | Accepted | Integration harness |
| [011](./ADR-011-standalone-analysis-pipeline.md) | Standalone Analysis Pipeline | Accepted | `maekon-analysis`, AnalysisProvider 포트 |
