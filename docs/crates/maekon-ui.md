> **DEPRECATED as of v0.1.5** — `maekon-ui` crate was removed when the project migrated from iced GUI to Tauri v2 + React WebView. This document is kept for historical reference only.
...
- `maekon-suggestion`: Suggestion presenter
