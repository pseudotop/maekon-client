[English](./maekon-web.md) | [한국어](./maekon-web.ko.md)
...
│   │                   # contract-frozen via docs/contracts/maekon-web.v1.openapi.yaml
...
`maekon-web` handlers depend on `WebStorage` (port), not `SqliteStorage` (adapter).
