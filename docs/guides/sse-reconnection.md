...
1. **Server (Rust)** -- `crates/maekon-web/src/handlers/stream.rs` +
   `crates/maekon-web/src/services/stream_service.rs`
2. **Client (TypeScript)** -- `crates/maekon-web/frontend/src/hooks/useSSE.ts`
...
refused, the Axum web server has not started (check that `maekon-app` is
...
- `crates/maekon-web/src/handlers/stream.rs` -- Axum SSE handler
- `crates/maekon-web/src/services/stream_service.rs` -- Stream query service
- `crates/maekon-web/src/services/stream_assembler.rs` -- Event serialization
- `crates/maekon-web/frontend/src/hooks/useSSE.ts` -- React SSE hook
- `crates/maekon-web/frontend/src/hooks/__tests__/useSSE.test.ts` -- Hook tests
- `crates/maekon-web/frontend/src/components/shell/StatusBar.tsx` -- Connection indicator
