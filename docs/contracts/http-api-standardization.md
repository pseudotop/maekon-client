...
- Transport DTO SSOT: `crates/maekon-api-contracts`
- Runtime route SSOT: `crates/maekon-web/src/routes.rs`
- Machine-readable interface snapshot: `docs/contracts/http-interface-manifest.v1.json`
- Generated OpenAPI snapshot: `docs/contracts/maekon-web.v1.openapi.yaml`

## Decision

1. Keep transport DTO ownership in `maekon-api-contracts`; handlers must not define public DTOs.
2. Keep route ownership in `maekon-web/src/routes.rs`.
...
3. CI OpenAPI artifact publication:
   - artifact name: `maekon-web-v1-openapi`
4. Release attachment publication:
   - file: `maekon-web.v1.openapi.yaml`
