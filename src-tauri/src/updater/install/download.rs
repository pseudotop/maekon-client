...
/// #6941: read a response body with a hard byte cap (content_length early-reject
/// + per-chunk streaming accumulation that aborts the instant the cap is crossed,
/// so a missing/forged Content-Length cannot defeat it). fail-closed.
