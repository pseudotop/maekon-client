...
<installer-gui-script minSpecVersion="2">
    <title>Maekon</title>
    <organization>com.maekon</organization>
    ...
    <choices-outline>
        <line choice="default">
            <line choice="com.maekon.app" />
        </line>
    </choices-outline>
    <choice id="default" />
    <choice id="com.maekon.app" visible="false">
        <pkg-ref id="com.maekon.app" />
    </choice>
    <pkg-ref id="com.maekon.app" version="$VERSION" onConclusion="none">#maekon-component.pkg</pkg-ref>
