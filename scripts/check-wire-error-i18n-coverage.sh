...
#   crates/maekon-web/frontend/src/i18n/wire-errors.en.json
#   crates/maekon-web/frontend/src/i18n/wire-errors.ko.json
#
...
REGISTRY="${ROOT_DIR}/crates/maekon-core/tests/wire_contract_snapshot.expected.txt"
EN_FILE="${ROOT_DIR}/crates/maekon-web/frontend/src/i18n/wire-errors.en.json"
KO_FILE="${ROOT_DIR}/crates/maekon-web/frontend/src/i18n/wire-errors.ko.json"
