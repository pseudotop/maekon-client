...
use maekon_core::ports::integration::{IntegrationSessionPort, IntegrationSessionStorePort};
...
mod tests {
    ...
    use maekon_core::ports::integration::IntegrationSessionStorePort;
    use tokio::sync::Mutex;

    use super::*;
    use crate::transport::IntegrationTransportConnectResponse;
