...
use crate::transport::IntegrationRequestProofFactory;
...
impl OidcDeviceFlowIntegrationAuthPort {
    ...
    async fn send_form(
        ...
        crate::http_transport::reject_cleartext_remote_url(url, "integration.oidc.endpoint")?;
    ...
    async fn refresh_access_token(
        ...
        if !status.is_success() {
            ...
            if status == reqwest::StatusCode::TOO_MANY_REQUESTS {
                let retry_after_secs = maekon_http_core::resilience::extract_retry_after(&response);
                ...
                || status == reqwest::StatusCode::UNAUTHORIZED
            {
                ...
                let error_body: OidcTokenErrorResponse =
                    maekon_http_core::outbound::read_body_capped(
                        response,
        ...
        let payload: OidcTokenSuccessResponse = maekon_http_core::outbound::read_body_capped(
            response,
            maekon_http_core::outbound::MAX_AUTH_RESPONSE_BYTES,
        )
        .await
        .map_err(|error| match error {
            maekon_http_core::outbound::BodyReadError::Transport(e) => {
...
impl IntegrationAuthPort for OidcDeviceFlowIntegrationAuthPort {
    ...
    async fn start_device_authorization(
        ...
        let payload: OidcDeviceAuthorizationResponse = maekon_http_core::outbound::read_body_capped(
            response,
            maekon_http_core::outbound::MAX_AUTH_RESPONSE_BYTES,
        )
        .await
    ...
    async fn poll_device_authorization(
        ...
        let error_body: OidcTokenErrorResponse = maekon_http_core::outbound::read_body_capped(
            response,
            maekon_http_core::outbound::MAX_AUTH_RESPONSE_BYTES,
        )
        .await
