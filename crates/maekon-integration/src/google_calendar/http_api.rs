...
//! [`hardened_client_builder`](maekon_http_core::outbound::hardened_client_builder) (credential
...
use maekon_http_core::outbound::{
    hardened_client_builder, read_text_capped, BodyReadError, TransportPolicy,
};
