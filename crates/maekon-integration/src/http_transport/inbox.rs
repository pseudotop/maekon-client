...
use crate::prompt_from_cloudevent;
use crate::transport::{IntegrationInboxTransportClient, IntegrationInboxTransportResponse};
...
struct PromptPullResponse {
    #[serde(default)]
    events: Vec<crate::IntegrationCloudEvent<ProactivePrompt>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
