...
pub fn insight_to_cloudevent(
    ...
    IntegrationCloudEvent {
        ...
        oneshimprivacy: Some(match packet.privacy_classification {
            maekon_core::models::integration::IntegrationPrivacyClassification::DeviceLocal => {
                "device_local"
            }
            maekon_core::models::integration::IntegrationPrivacyClassification::DerivedSummary => {
                "derived_summary"
            }
            maekon_core::models::integration::IntegrationPrivacyClassification::UserApprovedAttachment => {
