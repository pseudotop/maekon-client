...
use maekon_core::models::intent::{PresetCategory, WorkflowPreset, WorkflowStep};
use maekon_core::ports::preset_storage::PresetStorage;
...
impl PresetStorage for SqliteStorage {
    ...
    fn list_presets(&self) -> Result<Vec<WorkflowPreset>, CoreError> {
        ...
        let mut stmt = conn
            ...
            .map_err(|e| CoreError::Storage { code: maekon_core::error_codes::StorageCode::Failed, message: format!("prepare: {e}") })?;
...
mod tests {
    use super::*;
    use maekon_core::models::intent::{AutomationIntent, PresetCategory, WorkflowStep};
    use maekon_core::ports::preset_storage::PresetStorage;
