...
impl SqliteStorage {
    ...
    pub fn list_segments_between(
        ...
        let segments: Vec<maekon_core::models::tiered_memory::SegmentSummary> = stmt
            ...
            .filter_map(
                |(
                    ...
                    let end_time = chrono::DateTime::parse_from_rfc3339(&end_str)
                        .ok()?
                        .with_timezone(&chrono::Utc);
                    let trigger_reason: maekon_core::models::tiered_memory::TriggerReason =
                        serde_json::from_str(&format!("\"{reason_str}\"")).unwrap_or(
                            maekon_core::models::tiered_memory::TriggerReason::ScoreHigh,
                        );
                    ...
                    Some(maekon_core::models::tiered_memory::SegmentSummary {
                        segment_id: id,
                        start_time,
                        end_time,
