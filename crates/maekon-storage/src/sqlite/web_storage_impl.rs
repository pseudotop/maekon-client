...
impl DigestStorage for SqliteStorage {
    fn list_weekly_digests(
        ...
        let mut stmt = guard
            ...
            .map_err(|e| CoreError::Storage { code: maekon_core::error_codes::StorageCode::Failed, message: format!("Failed to prepare weekly_digests query: {e}") })?;
        let digests: Vec<maekon_core::models::weekly_digest::WeeklyDigest> = stmt
            ...
            .filter_map(|(stats_json, comparison_json, llm_narrative)| {
                let mut digest: maekon_core::models::weekly_digest::WeeklyDigest =
    ...
    fn save_weekly_digest(
        ...
        guard
            ...
            .map_err(|e| CoreError::Storage { code: maekon_core::error_codes::StorageCode::Failed, message: format!("Failed to save weekly digest: {e}") })?;
        Ok(())
    }
    ...
    fn save_daily_digest(&self, digest: &DailyDigest) -> Result<(), CoreError> {
        ...
        .map_err(|e| CoreError::Storage { code: maekon_core::error_codes::StorageCode::Failed, message: format!("Failed to save daily digest: {e}") })?;
...
impl GuiInteractionStorage for SqliteStorage {
    fn save_gui_interaction(&self, input: &NewGuiInteraction<'_>) -> Result<(), CoreError> {
        ...
        .map_err(|e| CoreError::Storage { code: maekon_core::error_codes::StorageCode::Failed, message: format!("Failed to save GUI interaction: {e}") })?;
        Ok(())
    }
...
impl maekon_core::ports::web_storage::HabitStorage for SqliteStorage {
