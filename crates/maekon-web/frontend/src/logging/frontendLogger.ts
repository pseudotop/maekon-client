...
type WindowWithFrontendBridge = Window & {
  __maekonFrontendBridgeInstalled__?: boolean
}
...
export function installFrontendLogBridge(surface: string): void {
  ...
  if (patchedWindow.__maekonFrontendBridgeInstalled__) return
  patchedWindow.__maekonFrontendBridgeInstalled__ = true
