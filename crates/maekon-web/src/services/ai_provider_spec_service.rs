...
pub use maekon_api_contracts::provider_specs::ProviderSurfaceCatalog;
pub use maekon_api_contracts::provider_specs::{ModelCatalogResponseShape, ProviderAuthScheme};
...
pub fn model_catalog_auth_scheme_for_surface(
    ...
    provider_specs::resolved_auth_scheme(
        provider_type,
        surface_id,
        maekon_api_contracts::provider_specs::ProviderTransportKind::ModelCatalog,
    )
    .map_err(ApiError::Internal)
}
