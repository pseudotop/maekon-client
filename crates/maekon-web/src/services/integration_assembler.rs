...
pub(crate) fn map_audit_record(
    ...
    IntegrationAuditRecordSummary {
        ...
        disposition: match record.disposition {
            maekon_core::models::integration::IntegrationEgressDisposition::Allow => "allow",
            maekon_core::models::integration::IntegrationEgressDisposition::Deny => "deny",
            maekon_core::models::integration::IntegrationEgressDisposition::RequireUserApproval => {
