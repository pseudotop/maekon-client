...
use maekon_api_contracts::reports::{AppStat, DailyStat, ReportPeriod, ReportQuery};
...
pub(crate) struct DailyStatsInput<'a> {
    ...
    pub(crate) metrics: &'a [maekon_core::models::system::SystemMetrics],
    pub(crate) events: &'a [Event],
    pub(crate) frames: &'a [maekon_core::models::storage_records::FrameRecord],
...
pub(crate) async fn build_app_stats(
    ...
    to: DateTime<Utc>,
    events: &[Event],
    frames: &[maekon_core::models::storage_records::FrameRecord],
) -> Vec<AppStat> {
...
pub(crate) fn build_hourly_activity(
    events: &[Event],
    frames: &[maekon_core::models::storage_records::FrameRecord],
) -> Vec<maekon_api_contracts::reports::HourlyActivity> {
...
pub(crate) fn build_productivity(
    ...
    total_idle_secs: u64,
    app_stats: &[AppStat],
    hourly_activity: &[maekon_api_contracts::reports::HourlyActivity],
) -> maekon_api_contracts::reports::ProductivityMetrics {
