...
impl IntegrationAuthCommandService {
    ...
    pub async fn get_auth_status(
        &self,
    ) -> Result<maekon_core::models::integration::IntegrationAuthStatus, ApiError> {
...
) -> Result<std::sync::Arc<dyn maekon_core::ports::integration::IntegrationInboxPort>, ApiError> {
...
fn require_auth(
    context: &IntegrationWebContext,
) -> Result<std::sync::Arc<dyn maekon_core::ports::integration::IntegrationAuthPort>, ApiError> {
