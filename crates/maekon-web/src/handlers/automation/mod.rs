...
mod tests {
    ...
    use maekon_core::config::{AiAccessMode, SceneActionOverrideConfig, SceneIntelligenceConfig};
    use maekon_core::models::intent::{AutomationIntent, ElementBounds};
    use maekon_core::models::ui_scene::{UiScene, UI_SCENE_SCHEMA_VERSION};
    ...
    use maekon_api_contracts::automation::ExecuteSceneActionRequest;
    ...
    fn execute_intent_hint_response_serializes() {
        let response = ExecuteIntentHintResponse {
            ...
            planned_intent: maekon_core::models::intent::AutomationIntent::ExecuteHotkey {
                keys: vec!["Ctrl".to_string(), "S".to_string()],
            },
            result: maekon_core::models::intent::IntentResult {
                success: true,
                element: None,
                verification: None,
                retry_count: 0,
    ...
    fn sample_scene_with_confidence(values: &[f64]) -> UiScene {
        UiScene {
            ...
            elements: values
                ...
                .enumerate()
                .map(
                    |(idx, confidence)| maekon_core::models::ui_scene::UiSceneElement {
                        ...
                        bbox_norm: maekon_core::models::ui_scene::NormalizedBounds::new(
                            0.1, 0.1, 0.2, 0.05,
                        ),
