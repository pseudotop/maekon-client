...
use axum::Json;
#[cfg(test)]
use maekon_api_contracts::metrics::MetricsResponse;
use maekon_api_contracts::metrics::{HourlyMetricsResponse, HourlyQuery};
...
) -> Result<Json<Vec<maekon_api_contracts::metrics::MetricsResponse>>, ApiError> {
    Ok(Json(
