...
) -> Json<maekon_api_contracts::integration::IntegrationAuditLogResponse> {
    Json(
...
pub async fn get_auth_status(
    State(context): State<IntegrationWebContext>,
) -> Result<Json<maekon_core::models::integration::IntegrationAuthStatus>, ApiError> {
    Ok(Json(
...
mod tests {
    ...
    impl IntegrationOutboxPort for TestOutbox {
        ...
        async fn list_pending(
            &self,
            _limit: usize,
        ) -> Result<Vec<maekon_core::models::integration::QueuedIntegrationEgressMessage>, CoreError>
        {
            Ok(Vec::new())
        }
    ...
    fn test_state() -> AppState {
        ...
        state.integration.runtime_status = Some(IntegrationOutboundRuntimeStatus {
            ...
            auth_profile_kind:
                maekon_core::models::integration::IntegrationAuthProfileKind::EnvToken,
