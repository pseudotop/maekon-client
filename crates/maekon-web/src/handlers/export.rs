...
use maekon_api_contracts::export::ExportQuery;
#[cfg(test)]
use maekon_api_contracts::export::{EventExportRecord, MetricExportRecord};
...
mod tests {
    ...
    fn make_test_session(
        ...
        category: &str,
        duration: u64,
    ) -> maekon_core::models::storage_records::FocusWorkSessionRecord {
        maekon_core::models::storage_records::FocusWorkSessionRecord {
            id,
    ...
    fn ical_export_produces_valid_calendar() {
        ...
        assert!(ical.contains("UID:session-1@maekon\r\n"));
