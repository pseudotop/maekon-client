...
use maekon_core::binary_quantizer::{BinaryCode, QuantileThresholds};
...
mod hnsw_tests {
    use super::*;
    use chrono::Utc;
    use maekon_core::models::embedding::EmbeddingContentType;
    ...
    impl AnnIndex for MockAnnIndex {
        ...
        async fn search(&self, _query: &[f32], _k: usize) -> Result<Vec<(u64, f32)>, CoreError> {
