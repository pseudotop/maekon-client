...
use maekon_core::config::GuiIntelligenceConfig;
...
mod tests {
    ...
    use maekon_core::models::gui_interaction::GuiElement;
    ...
    fn scroll_interaction_counted_once() {
        ...
        event.interaction = Some(InteractionType::Scroll {
            direction: maekon_core::models::gui_interaction::ScrollDirection::Down,
            amount: 3.0,
        });
