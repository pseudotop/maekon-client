...
use maekon_core::models::embedding::SearchResult;
    ...
    async fn keyword_search(
        ...
        let results = fts_results
            ...
            .map(|r| SearchResult {
                ...
                content_type: maekon_core::models::embedding::EmbeddingContentType::SegmentSummary,
                content_label: None,
                score: r.rank,
                similarity: r.rank,
                time_decay: 1.0,
...
mod tests {
    ...
    use maekon_core::models::embedding::{EmbeddingContentType, SearchResult as VectorResult};
    ...
    impl VectorStore for MockVectorStore {
        async fn store(
            &self,
            _vector: Vec<f32>,
            _metadata: maekon_core::models::embedding::EmbeddingMetadata,
        ) -> Result<(), CoreError> {
            Ok(())
        }
        ...
        async fn search_filtered(
            ...
            limit: usize,
            _time_decay_hours: f32,
            _filters: &maekon_core::models::embedding::SearchFilters,
        ) -> Result<Vec<VectorResult>, CoreError> {
            Ok(self.results.iter().take(limit).cloned().collect())
        }
