...
use maekon_core::models::coaching::{CoachingEventRow, GoalProgressView};
...
impl From<maekon_core::models::coaching::HabitStreakRow> for HabitStreakResponse {
    fn from(row: maekon_core::models::coaching::HabitStreakRow) -> Self {
        Self {
