//! GUI interaction runtime session models — focus/highlight/execution DTOs,
//! the session state machine, and the request/response types for the
//! propose → highlight → confirm → execute session lifecycle.
//!
