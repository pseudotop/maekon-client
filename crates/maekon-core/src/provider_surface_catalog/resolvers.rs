...
use crate::provider_surface::{provider_type_from_vendor_id, provider_vendor_id_or_default};

use super::models::{
    ProviderModelCatalogTransportSpec, ProviderModelSupportStatus, ProviderParameterProfile,
    ProviderSurfaceSpec, ProviderTransportSpec,
};
...
use super::parsers::{parse_auth_scheme, parse_provider_type_name, parse_request_shape};
...
pub fn default_surface_id_for_access_mode(
    ...
    let mut candidates = super::surface_catalog()?
        ...
        .filter(|surface| surface.execution_kind == execution_kind)
