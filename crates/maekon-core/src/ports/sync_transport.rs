...
/// - `FileSyncTransport`   (maekon-storage)  -- encrypted JSON in shared folder
/// - `RemoteSyncTransport` (maekon-network)  -- REST/gRPC to sync endpoint
/// - `LanSyncTransport`    (maekon-network)  -- mDNS + direct TCP (Phase 3b)
///
